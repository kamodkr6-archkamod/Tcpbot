...
async def black666(client_id, key, iv):
    banner_text = "[FF0000][B][C] ERROR , WELCOME TO [FFFFFF]SPIDER [00FF00]___X³____ BOT ! \n[FFFF00]NEW VERSION NEW FUNCTION !\n[FF0000]TELEGRAM : @SHAHNILRAZA\n\n"     
    fields = {
        1: 5,
        2: {
            1: int(client_id),
...
[FF0000]━[00FF00]━[0000FF]━[FFFF00]━[FF00FF]━[00FFFF]━[FFA500]━[FF1493]━[00FF7F]━[FFD700]━[00CED1]━[9400D3]━[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]
[FFD700] ＦＯＬＬＯＷ    ＭＥ   ＩＮ   [87CEEB]TELEGRAM: [FF0000]@SHAHNILRAZA
[FF0000]━[00FF00]━[0000FF]━[FFFF00]━[FF00FF]━[00FFFF]━[FFA500]━[FF1493]━[00FF7F]━[FFD700]━[00CED1]━[9400D3]━[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]"""
    fields = {
    1: 5,
    2: {
...
"""
            ...
            # For example:
            title_packet = await convert_kyro_to_your_system(uid, chat_id, key, iv, nickname="SPIDER", title_id=title_id)
...
async def noob(target_uid, chat_id, key, iv, nickname="SPIDER", title_id=None):
    """EXACT conversion with customizable title ID"""
    try:
        # Use provided title_id or get random one
        if title_id is None:
...
async def send_all_titles_sequentiallly(uid, chat_id, key, iv, region, chat_type):
    ...
    # Send initial message
    start_msg = f"""[B][C][00FF00] Noobde SPIDER ya meku agar tu noob bolra toh tu g a y hai
...
"""
    ...
    try:
        for index, title_id in enumerate(all_titles):
            ...
            # You'll need to use your existing title sending logic here
            # For example:
            title_packet = await noob(uid, chat_id, key, iv, nickname="SPIDER", title_id=title_id)
                    ...
                    try:
                        ...
                        if "1234567890" in WHITELISTED_UIDS:
                            ...
                            try:
                                ...
                                bot_uid = 13777711848
                                message_text = f" Can't accept Your request Talk to SPIDER"
...
[FFFFFF]📱 CONTACT: [FFFF00]@SHAHNILRAZA
[00FF00]»»————-　★　————-««
...
[b][i][FFC0CB]youtube: @SPIDERSETUL YT [/b]

[b][c][FFC0CB]subcribe: my_channel[FFFFFF]
 
[b][i][FFA500]telegram: @SPIDERA0S[/b]

[b][c][FFA500]telegram contact: @SHAHNILRAZA[A52A2A]
...
#=============================BAN CHECK=================================
                        ...
                        BLOCKED_NAMES = ["spider", "SPIDY", "SPIDER", "Shahnil , shahnil"]  # Add your actual name
...
async def MaiiiinE():
    ...
    os.system('clear')
    print("=" * 50)
    print("🤖 SPIDY LEGACY BOT - INITIALIZING")
    print("=" * 50)
    ...
    os.system('clear')
    print("🤖 SPIDY LEGACY BOT - STARTING")
    print("=" * 50)
    ...
    os.system('clear')
    print("🤖 SPIDY LEGACY BOT - CONNECTING")
    print("=" * 50)
    print("┌────────────────────────────────────┐")
    print("│ ██████████████████████████████████ │")
    print("└────────────────────────────────────┘")
